...
Image {
    ...
    readonly property string cachePath: imageHash ? `${Utils.stringify(Utils.imagecache)}/${imageHash}@${maxCacheSize}x${maxCacheSize}.png` : ""
    ...
    onStatusChanged: {
        ...
        var strippedImagePath = Utils.strip(imagePath);
        var sourceStripped = Utils.strip(sourceStr);
